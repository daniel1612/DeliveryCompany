...
public class Van extends Truck{
	/**
	 * A vehicle Van that collects a package from the sender's address to the local branch and delivers the package 
	 * from the destination branch to the recipient's address (only one package per trip). The class has no fields.
	 */

	/**
	 * A default constructor that produces a random object according to the same rules as in the parent class.
	 */
	 ...
	 * @param licensePlate - licensePlate of truck
